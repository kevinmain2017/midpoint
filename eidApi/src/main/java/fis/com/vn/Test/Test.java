...
public class Test {
	public static void main(String[] args) {
		try {
			...
			builder.addTextBody("gender", "1", ContentType.TEXT_PLAIN.withCharset(Charset.forName("utf-8")));
			...
			builder.addTextBody("phone", "0984707337", ContentType.TEXT_PLAIN.withCharset(Charset.forName("utf-8")));
			builder.addTextBody("model_device", "SAMSUNG-"+"1", ContentType.TEXT_PLAIN.withCharset(Charset.forName("utf-8")));
			builder.addTextBody("email", "abc@gmail.com", ContentType.TEXT_PLAIN.withCharset(Charset.forName("utf-8")));
			...
			builder.addBinaryBody(
			    "file",
			    new File("D:\\CHINH\\anh\\anhcmtreal\\anhlv_cmt_mt.jpg"),
